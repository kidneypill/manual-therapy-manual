...
# 검사 제외 디렉토리
SKIP_DIRS = {"medicalData/_schema", "medicalData/Concepts", "medicalData/Assets", ".git"}
...
def detect_schema_type(path: Path):
    ...
    rel = path.relative_to(MEDICAL_DATA)
...
def main():
    ...
    search_root = MEDICAL_DATA / args.path if args.path else MEDICAL_DATA
